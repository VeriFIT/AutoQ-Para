...
public:
   ...
   */
    ...
    virtual std::any visitSwitchStatement(qasm3Parser::SwitchStatementContext *context) = 0;

    virtual std::any visitSwitchCaseItem(qasm3Parser::SwitchCaseItemContext *context) = 0;
    ...
    virtual std::any visitNopStatement(qasm3Parser::NopStatementContext *context) = 0;
