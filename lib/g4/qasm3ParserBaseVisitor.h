...
// Generated from g4/qasm3Parser.g4 by ANTLR 4.13.2
...
public:
  ...
  virtual std::any visitSwitchStatement(qasm3Parser::SwitchStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitSwitchCaseItem(qasm3Parser::SwitchCaseItemContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitNopStatement(qasm3Parser::NopStatementContext *ctx) override {
    return visitChildren(ctx);
  }
